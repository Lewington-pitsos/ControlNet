...
python .\tool_add_control_sd21.py models\v2-1_768-ema-pruned.ckpt .\checkpoints\cldm_v21.ckpt             .\models\cldm_v21.yaml
python .\tool_add_control_sd21.py models\v2-1_768-ema-pruned.ckpt .\checkpoints\cldm_v21_normal_conv.ckpt .\models\cldm_v21_normal_conv.yaml
python .\tool_add_control_sd21.py models\v2-1_768-ema-pruned.ckpt .\checkpoints\cldm_v21_singleon.ckpt    .\models\cldm_v21_singleton.yaml
python .\tool_add_control_sd21.py models\v2-1_768-ema-pruned.ckpt .\checkpoints\cldm_v21_rising.ckpt      .\models\cldm_v21_rising.yaml
